...
let
  ...
  sshKeysSopsFile = (worktreePath.of "modules/home-manager/ssh.d/keys.yaml");
...
in
{
  ...
  config = {
    sops = {
      ...
      defaultSopsFile = lib.mkDefault (worktreePath.of ".secrets");
      ...
      secrets = {
        ...
        "io-nxmatic-nix-darwin-home.key.bare" = {
          sopsFile = (worktreePath.of "catalog/cache-trust.yaml");
          format = "yaml";
