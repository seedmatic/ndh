...
# a JSON file {key: value} of the network settings (the single-source fabricBrConfig,
...
for attempt in 1 2 3 4 5; do
  ...
  echo "[incus-fabric-br] network edit attempt ${attempt} failed (ETag conflict?), retrying" >&2
  sleep 1
done
echo "[incus-fabric-br] network edit failed after 5 attempts" >&2
exit 1
