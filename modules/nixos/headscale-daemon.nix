...
let
  ...
  headscaleConfigYaml = pkgs.writeText "headscale-config.yaml" ''
    # Generated by modules/nixos/headscale-daemon.nix — do not edit by
    # hand.  Persistent state (DB, keys) lives under ${stateDir};
    # the config itself is re-rendered on every nixos-rebuild switch.
