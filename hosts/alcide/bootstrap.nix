{ lib, config, pkgs, ... }:
# Stage 1 Bootstrap: Minimal nix-darwin that only activates the Linux builder
# This creates /etc/nix/machines and starts the darwin-linux-builder VM
# After this completes, use the Linux builder to build the full alcide configuration
{
  imports = [
